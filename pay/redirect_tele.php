...
*/
	...
	//Redirect URLs
	$redirectUrls->setReturnUrl('https://mobidoc.it/pay/auth_tele.php?approved=true&booking_id='.$booking_ids_array[0])
		->setCancelUrl('https://mobidoc.it/pay/auth_tele.php?approved=false');
