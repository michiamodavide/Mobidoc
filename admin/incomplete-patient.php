      ...
      <div class="doctors_block">
       ...
       <div class="regi_doctor_card">
        ...
        <div id="w-node-cf99e8f70307-80dd982b" class="regi_button_container">
         <div id="w-node-cf99e8f70308-80dd982b">
          <a href="/paziente/patient-register.php?icp=<?php echo $patient_id?>" target="_blank" class="button-10 w-button">Profilo completo</a></div>
        </div>
       </div>
