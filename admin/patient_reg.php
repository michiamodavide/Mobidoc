...
//  $passwd = strtolower($_POST['call_first_name'].'123');
  ...
  if (mysqli_num_rows($result_fisical) > 0) {
    $sql = "UPDATE `paziente_profile` SET `caller_name` = '$caller_fname', `via` = '$address', `admin_note` = '$admin_note', `gmap_address` = '$gmap_address', `privacy_consent` = '$check' WHERE `fiscale` = '$fiscal'";
