          ...
          <div class="booking_details">
            ...
            <div class="bottom">
             ...
             <?php if (isset($admin_booking)){
              ...
              ?>
             <div class="glance_details">
              <input type="checkbox" <?php echo $is_check?> class="admin_pyment_confirm" id="admin_payment_check" name="admin_payment_check" data-id="<?php echo $bbb_id?>" value="<?php echo $admin_book_status?>">
              <label for="admin_payment_check">Pagamento</label><br>
             </div>
             <?php }?>
            </div>
          </div>
