<?php session_start();	
	...
	*/
		...
		$sql = "update doctor_profile set fname='$fname', lname='$lname', dob='$dob', photo='$photo', fiscale='$fiscal', vat_number='$vat', education='$education', experience='$experience', phone='$tel', street_name='$street_name', street_no='$street_no', comune='$comune', province='$province', cap='$cap', dor='$dor', lastDatePrivacyConsent='$dor' where email = '$email'";
