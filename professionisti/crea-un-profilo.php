          ...
          <form id="email-form" name="email-form" data-name="Email Form" class="update_form" action="create.php" method="post" enctype="multipart/form-data">
            <div>
              <div class="form_section">
                ...
                <div class="dual_container">
                  <input type="text" class="inputs proff w-input" maxlength="100" id="nome" name="nome" data-name="nome" value="<?PHP echo $r1;?>" id="nome" required="" readonly>
                  <input type="text" class="inputs proff w-input" maxlength="100" id="cognome" name="cognome" data-name="cognome" value="<?PHP echo $r2;?>" id="cognome" required="" readonly>
                  <input type="password" class="inputs proff w-input" maxlength="100" id="pwrds" name="pwrds" data-name="pwrds" placeholder="Password *" id="pwrds" required="">
                  <input type="password" class="inputs proff w-input" maxlength="100" id="Cnfrm_pwrd" name="Cnfrm_pwrd" data-name="Cnfrm_pwrd *" placeholder="Conferma Password" id="Cnfrm_pwrd" required="">
                  <input type="text" class="datepicker-here inputs proff w-input"  data-language="it" data-date-format="dd-mm-yyyy" maxlength="256" name="dob" placeholder="Data di Nascita" id="dob" required="">
                  <input type="text" class="inputs proff w-input" name="fiscal_code" data-name="fiscal_code" placeholder="Codice Fiscale *" id="fiscal_code" required="">
                  <input type="text" class="inputs proff w-input" name="vat_number" data-name="vat_number" placeholder="Partita IVA" id="vat_number">
			          </div>
              </div>
              ...
              <div class="form_section">
                ...
                <textarea placeholder="Descrizione Personale *" maxlength="10000" id="personal_description" name="personal_description" data-name="personal_description" class="text_area_profile personal_description w-input" required></textarea>
                <textarea placeholder="Educazione *" maxlength="10000" id="educazione" name="personal_description-3" data-name="Personal Description 3" class="text_area_profile education w-input" required></textarea>
                <textarea placeholder="Esperienze Professionali *" maxlength="10000" id="esperienze_professionali-2" name="personal_description-2" data-name="Personal Description 2" class="text_area_profile w-input" required></textarea>
              </div>              
            </div>
					...
					?>
                      <div class="visit">
                        <div class="visit_heading">
                          <div class="text-block-42"><?php echo $visit_name;?></div><img src="../images/arrow.svg" alt="" class="image-13"></div>
            ...
            <div>
              ...
              <div class="form_section">
                ...
                <div class="dual_container">
                  <input type="email" class="inputs proff w-input" maxlength="100" name="email" data-name="Email" value="<?PHP echo $r3;?>" id="email" required="" readonly>
                  <input type="text" class="inputs proff w-input" maxlength="15" name="tele" data-name="Tele" placeholder="Telefono *" id="tele" required="">
                  <input type="text" class="inputs proff w-input" maxlength="100" name="Via" data-name="Via" placeholder="Via *" id="Via" required="">
                  <input type="text" class="inputs proff w-input" name="Civico" data-name="Civico" placeholder="Civico *" id="Civico" required="">
                ...
                <div class="check_accept" style="margin-top:30px;">
                  <label class="w-checkbox checkbox-field">
                    ...
                    <span class="text-span-4">
                      ...
                      <a href="https://drive.google.com/file/d/12zuzO-CGass79yydWfR-JBKg_lyKw_YB/view?usp=sharing" target="_blank"><span class="text-span-4"> leggi di più</span></a>
                    </span>
                    </label>
                </div>   
              </div>
