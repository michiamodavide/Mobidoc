...
<div class="master_head login">
    ...
    <div class="masthead_container login diff">
        ...
        <div class="div-block-31 diff diffrent">
            ...
            <div class="text-block-57">Unisciti al Team di Mobidoc compilando il seguente form. Ci penseremo noi a
                contattarti.
            </div>
        </div>
        ...
        <div class="login_form_container proff">
            <div class="form_parent_container">
                <div data-w-id="0519d48f-fd8c-3004-c5b2-f235eaac07c1" class="forms_container proff w-clearfix">
                    <div class="login_form w-clearfix w-form">
                        ...
                        <form name="email-form" id="regist_form" class="form-4" action="<?php if ($admin == 1) {
                            echo 'register.php?admin';
                        } else {
                            echo 'register.php';
                        } ?>" method="post" enctype="multipart/form-data">
                            <div class="dual_container proff">
                                <input type="text" class="text-field-3 proff w-input" name="fname"
                                       data-name="First Name" placeholder="Nome" id="Name" pattern="[A-Z][a-z]*"
                                       title="Il nome deve essere in lettere e la prima lettera deve essere maiuscola"
                                       required="" autocomplete="off">
                                <input type="text" class="text-field-3 proff w-input" name="cognome" data-name="Cognome"
                                       placeholder="Cognome" id="Cognome" required="" pattern="[A-Z][a-z]*"
                                       title="Il nome deve essere in lettere e la prima lettera deve essere maiuscola"
                                       autocomplete="off">
                            </div>
                            <input type="email" class="text-field-3 proff w-input" autocomplete="off" maxlength="50"
                                   name="email" data-name="email" placeholder="Email" id="email" required="">
                            <input type="email" class="text-field-3 proff w-input" autocomplete="off" maxlength="50"
                                   name="confirm-email" data-name="confirm-email" placeholder="Conferma Email"
                            ...
                            */
                            ...
                            <?php if ($admin == 0) { ?>
                                <div class="upload_cv">
                                    <div class="div-block-56"><img src="../images/upload.svg" width="24" alt=""><img
                                                src="../images/warning.svg" width="24" alt="" class="image-18"><img
                                                src="../images/file.svg" width="21" alt="" class="image-17">
                 ...
                 <span class="prff w-form-label w-m">
                      <span class="text-span-4">
                       Consenso al Trattamento di Dati Personali: Letta e compresa l’informativa privacy, premendo su “Presto il consenso” o “Nego il consenso”, esprimo la mia volontà in merito al trattamento dei miei dati personali per finalità di marketing: invio di comunicazioni di carattere commerciale, informativo e promo-pubblicitario su prodotti, servizi ed attività di Tekamed S.r.l., con modalità automatizzate di contatto o comunicazioni elettroniche mediante l’utilizzo di posta elettronica e messaggi del tipo SMS, IM, MMS, notifiche push; compimento di indagini di mercato e rilevazione del gradimento e della soddisfazione sui servizi resi agli interessati. Comunicazioni informative, commerciali e pubblicitarie che acconsento a ricevere anche tramite posta cartacea o chiamate telefoniche. Questo consenso potrà essere revocato nello stesso modo.
                            ...
                            <?php if ($admin == 0) { ?>
                                <div>
                                    <input type="file" name="cv" class="file_upload_input"
                                           accept=".pdf, application/msword" required>
                                </div>
                            <?php } ?>
                            ...
                            if (isset($_POST['submit']) && $_POST['email'] == $_POST['confirm-email']) {
                                ...
                                if (!$res['success']) {
                                    ...
                                    $dob = '1970-01-01';
                                    if ($admin == 0) {
                                        $sql = "insert into doctor_profile (fname, lname, email, cv, privacy_consent, lastDatePrivacyConsent, marketing_consent, lastDateMarketingConsent, dob) values('" . $fname . "', '" . $lname . "', '" . $email . "', '" . $cv_status . "', '" . $privacy_checkbox . "', '" . $dor . "', '" . $market_checkbox . "', '" . $market_mod . "', '" . $dob . "')";
                                    } else {
                            ...
                            <br>
                            <input type="submit" name="submit" value="Invia" id="submit_application"
                                   class="button gradient login_button proff w-button">
            ...
            <div class="div-block-40">
                ...
                <div class="text-block-29 proff">Per assistenza chiama il <span
                            class="text-span-3 proff">335 77 988 44</span></div>
            </div>
        </div>
    </div>
</div>
