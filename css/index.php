...
La prosecuzione della navigazione, mediante consenso (pressione su "ACCETTA"), comporta l'accettazione all'uso dei cookies ed alla loro scrittura sul tuo dispositivo
    ...
    <div class="custom_container cta_container">
      <div class="cta_card _1" style="text-align: left;">
        <div class="text-block-5">
			<img src="images/qestion-icon.png" width="77" alt="">
			
			<h2>Cos'è Mobidoc?</h2>
			Mobidoc è un servizio di visite mediche a domicilio a nessun costo aggiuntivo per il paziente.</div></div>
      
      <div class="cta_card _2" style="text-align: left;">
        <div class="text-block-5">
			<div class="img-left">
			...
			<div class="text-left">
			<h2>Dove Operiamo? </h2>
			Al momento offriamo visite a domicilio per pazienti  in provincia di Ferrara e Rovigo.
				</div>
      </div>
    </div>
  </section>
