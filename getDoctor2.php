...
?>
    ...
    <div class="professionist_card-2 selecting">
        ...
        <div class="button_container">
            <a href="#" class="button-3 gradient select_button w-button"  onClick="setDoctor('<?php echo $q;?>','<?php echo $id;?>'); $('.selected_tick').removeClass('selected_true'); $(this).parent().siblings('.professionist_image_container').children('.selected_tick').toggleClass('selected_true');">Seleziona</a>
