    ...
    $(document).mouseup(function (e) { 
      ...
      $(document).ready(function(){ 
        ...
        var service_add = "<div class='visit_subitem selected'><div style=' width:65%;'><input type='checkbox' style='display:none;' checked class='text-block-44' value='"+current_visit_type+"' name='service_name"+selected_visit_counter+"'>"+image_code+current_visit_type+"</div><div class='price_n_remove'><div class='price_input'><div>€</div><input type='number' class='input_num w-input' maxlength='256' name='service_price"+selected_visit_counter+"'  min='1' data-name='Field' id='field' required=''></div><img src='../images/minus_1.svg' class='image-14' onClick='service_remove(this)'></div></div>";
