...
.masthead{background-image: linear-gradient(177deg, rgba(12, 217, 237, 0.7), rgba(0, 40, 92, 0.6)), url(images/Medicina-Interna-e-Geriatria.jpg?v=4);}
  </style>
 <script>
...
<body>
  ...
  <div class="section-13">
    <div class="custom_container info_container">
      ...
      <div><img src="images/Medicina-Interna-e-Geriatria.jpg" alt="" class="image-5"></div>
    </div>
  </div>
