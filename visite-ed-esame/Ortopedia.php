...
<head>
 ...
 <link href="../css/new-styles.css?v=4" rel="stylesheet" type="text/css">
...
.masthead{background-image: linear-gradient(177deg, rgba(12, 217, 237, 0.7), rgba(0, 40, 92, 0.6)), url(images/Ortopedia.jpg?v=2);}
  </style>
 <script>
...
<body>
  ...
  <div class="section-13">
    <div class="custom_container info_container">
      ...
      <div><img src="images/Ortopedia.jpg" alt="" class="image-5"></div>    </div>
  </div>
