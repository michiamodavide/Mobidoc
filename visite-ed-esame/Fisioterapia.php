...
<head>
  ...
  <style>
    ...
    .masthead{background-image: linear-gradient(177deg, rgba(12, 217, 237, 0.7), rgba(0, 40, 92, 0.6)), url(images/fisioterapia.jpg??v=2);}
  </style>
  <script>
...
<section class="masthead visit_page_header">
  <div class="masthead_container">
    <div class="column"><img src="<?php echo  $icon;?>?v=4" height="80" alt="" class="image-7">
...
<div class="section-13">
  <div class="custom_container info_container">
    ...
    <div><img src="images/fisioterapia.jpg?v=3" alt="" class="image-5"></div>
  </div>
</div>
