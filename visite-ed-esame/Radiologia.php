...
<body>
  ...
  <div class="section-13">
    <div class="custom_container info_container">
      ...
      <div><img src="images/Radiologia.jpg" alt="" class="image-5"></div>
    </div>
  </div>
...
//           array_push($unique_email, $continuousemail);
  ...
  <div data-w-id="66c0daf9-02db-a5aa-e005-bf5a69c766b4" style="opacity:0;display:grid !important;overflow: auto" class="vselect_visite">
  ...
  <script src="../js/webflow.js?v=5" type="text/javascript"></script>
...
$(document).ready(function(){
   $('.searching_doct_area_textfield').focusin(function(){
        $('.searched_area_doct_container').addClass('open');
   });
