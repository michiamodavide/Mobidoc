<?php
  ...
  include '../connect.php';
	$sql = "select * from password_reset where reset_code = '".$reset_code."'";
...
?>
<!DOCTYPE html>
<html data-wf-page="5de222be59d27b411b1f293e" data-wf-site="5d8cfd454ebd737ac1a48727">
<head>
  <meta charset="utf-8">
  <title>Change Password - Paziente</title>
  <meta content="Change Password - Paziente" property="og:title">
        ...
        <div class="w-form">
          <form id="email-form" name="email-form" data-name="Email Form" class="form-5" action="change_password_php.php" method="post">
            <h2 class="heading-21 diff">
              ...
              <input type="password" class="text-field-3 w-input" maxlength="256" name="cnfirm_pwrd" data-name="confirm-password" placeholder="Conferma Password" id="confirm-password" required="">
              <input type="submit" value="Cambia" class="button gradient w-button" id="submit_profile">
