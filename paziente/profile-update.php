...
<body>
  ...
  <section class="section-19">
    <div class="custom_container update_form">
      <p class="paragraph-9">Per farti accedere ai servizi Mobidoc abbiamo bisogno dei tuoi dati anagrafici.</p>
            ...
            <div>
              <div class="form_section">
                ...
                <div class="dual_container diff">
                  <input type="text" class="inputs w-input" maxlength="256" name="first_name" value="<?PHP echo $name;?>" data-name="first_name" placeholder="Nome" id="first_name" readonly>
                  <input type="text" class="inputs w-input" maxlength="256" name="last_name" value="<?PHP echo $cogname;?>"  data-name="last_name" placeholder="Cognome" id="last_name" readonly>
                </div>
                <div class="dual_container diff">
              ...
              <div class="form_section">
                ...
                <div class="dual_container diff">
                  <input type="text" class="inputs w-input" maxlength="256" name="Via" data-name="Via" placeholder="via *" id="Via" required="">
                  <input type="text" class="inputs w-input" maxlength="256" name="civico" data-name="civico" placeholder="Civico *" id="civico" required="">
                </div>
              </div>
              <div class="form_section">
              ...
              <script>
                ...
                <div class="div-block-34">
                  ...
                  /*
                    ...
                    <div id="dp_2" style="width:100%; height:100%; background: url('../images/Group-556.jpg'); background-position:center; background-size:cover; cursor: pointer"></div>                    </div>
                      ...
                      $('.text-block-33, .profile_image_container').click(function(){
                        ...
                        $('.upload_image').change(function() {
                          ...
                          $('.text-block-33').html(filename);
                            ...
                            $('.text-block-33').html("Immagine del profiloe");
                          }
                        });
                      });
                    });
